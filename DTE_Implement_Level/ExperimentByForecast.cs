...
namespace DTE_Implement_Level
{
    public class ExperimentByForecast
    {
        ...
        private readonly int _countPointsForMemmory = 5;

        private readonly object loadTxtObj = new object();

        private readonly object createFuzzyLabels = new object();

        private readonly object createFuzzyTrends = new object();

        private readonly object createRuleTrends = new object();

        private readonly object createPointTrends = new object();

        private readonly object genSituationsByEntropy = new object();

        private readonly object genSituationsByFuzzy = new object();

        private readonly object runForecast = new object();
